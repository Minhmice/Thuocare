...
/**
 * Marks a dose as taken for the signed-in patient.
 *
 ...
 */
export function useMarkDoseTaken(todayIso: string) {
  ...
  return useMutation({
    mutationFn: async ({ prescriptionItemId, scheduledTime }: MarkTakenInput) => {
      ...
      return markDoseTaken(mobileSupabase, actor, {
