...
2.  **Profile Summary Card (Hero Section):**
    ...
    *   **Content:**
        ...
        *   *Optional placeholder:* A reserved circular area for a future profile image/avatar, but without requiring an upload feature in MVP.
...
3.  **Settings Section (Grouped below summary):**
    ...
    *   **Sub-section: Account Details (Lightweight view):**
        ...
        *   *Note:* This can be combined with the Profile Summary if it keeps the layout clean and readable. If separated, it should be a simple list of labels and values.
...
4.  **Support Section:**
    ...
    *   **Content:**
        ...
        *   *Optional:* "About Thuocare" (Tappable row for app version, legal links, etc.).
